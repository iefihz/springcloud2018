...
import com.iefihz.cloud.fallBack.UserFeignClientHystrixFallBackFactory;
...
@FeignClient(
        ...
        /*fallback = UserFeignClientHystrixFallBack.class,*/
        fallbackFactory = UserFeignClientHystrixFallBackFactory.class,
